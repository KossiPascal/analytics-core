...
import {
  LayoutDashboard, FolderKanban, Target, ListChecks, FileBarChart2, RefreshCw,
} from 'lucide-react';
...
type TabType = 'dashboard' | 'projects' | 'orcs' | 'activities' | 'reports';
      ...
      <Card>
        <CardBody>
          ...
          <div className={styles.tabContent}>
            {activeTab === 'dashboard'  && <DashboardTab  key={refreshKey} onNavigate={setActiveTab} />}
