...
export const DatabaseConnectionTab:React.FC<{showTitle?:boolean}>=({showTitle=true})=> {
        ...
        <CardBody>
          <div className={styles.form}>
            <div className={styles.grid + ' ' + styles.grid3}>
              <Field name="type" value={form.type} onChange={updateField} type={"select"} list={DB_TYPES} label={"Type"} icon={<FaDatabase />} placeholder="Ex: postgres" required={true} />
