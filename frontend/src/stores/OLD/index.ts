...
import { COUNTRIES, REGIONS, PREFECTURES, COMMUNES, HOSPITALS, DISTRICT_QUARTIERS, VILLAGE_SECTEURS, CHWS, RECOS } from '@/utils/TestData';
...
export const useStore = create<AppStore>()(
  persist(
    ...
    }),
    {
      ...
      // Réhydratation: mettre à jour les org units depuis TestData
