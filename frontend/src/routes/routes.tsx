...
import { Home, FileText, Map, Users, Shield, BookOpen, Gauge, Activity, Eye, ChevronRight, User, Settings, LogOut, Smartphone, Mic, FolderKanban } from 'lucide-react';
...
export const ROUTES_ITEMS: RouteItem[] = [
  ...
  {
    label: 'Projets & ORCs',
    path: ROUTES.prosi.root(),
    component: PAGES.ProsiPage,
