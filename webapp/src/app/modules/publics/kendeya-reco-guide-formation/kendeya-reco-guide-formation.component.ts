...
@Component({
  selector: 'kendeya-reco-guide-formation',
  templateUrl: './kendeya-reco-guide-formation.component.html',
  styleUrl: './kendeya-reco-guide-formation.component.css'
})
export class KendeyaRecoGuideFormationComponent implements AfterViewInit {
