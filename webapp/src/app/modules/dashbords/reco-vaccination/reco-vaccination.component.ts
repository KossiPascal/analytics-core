...
import { RecoMegDashboardUtils, RecoVaccinationDashboard } from '@kossi-models/dashboards';
...
export class RecoVaccinationDashboardComponent implements OnInit, AfterViewInit {
