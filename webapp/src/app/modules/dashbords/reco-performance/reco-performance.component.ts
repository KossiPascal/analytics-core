...
import { RecoPerformanceDashboard, RecoPerformanceDashboardUtils } from '@kossi-models/dashboards';
...
import { currentYear, currentMonth, getMonthsList, getYearsList, toArray, monthByArg, notNull } from '@kossi-src/app/utils/functions';
...
export class RecoPerformanceDashboardComponent implements OnInit, AfterViewInit {
