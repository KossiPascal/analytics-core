...
const getServicesState = (state:any) => state.services || {};
const getReportsState = (state:any) => state.reports || {};
const getMessagesState = (state:any) => state.messages || {};
const getContactsState = (state:any) => state.contacts || {};
const getAnalyticsState = (state:any) => state.analytics || {};
const getGraphiquesState = (state:any) => state.graphiques || {};
const getTargetAggregatesState = (state:any) => state.targetAggregates || {};
const getTasksState = (state:any) => state.tasks || {};
...
export const Selectors = {
  ...
  listContains: createSelector(getReportsState, (reportsState) => {
    return (id:any) => reportsState.reportsById.has(id);
  }),
  ...
  contactListContains: createSelector(getContactsState, (contactsState) => {
    return (id:any) => contactsState.contactsById.has(id);
  }),
  ...
  // graphiques
  getGraphiquesModules: createSelector(getGraphiquesState, (graphiquesState) => graphiquesState.graphiquesModules),
