...
@Component({
  ...
  templateUrl: './repports-orgunit.component.html',
  styleUrls: ['./repports-orgunit.component.css'],
})
export class RepportsOrgunitSelectorComponent implements OnInit, AfterViewInit {
  @Attribute('id') id: any;
