...
from backend.src.okr_manager.models.models import OkrActivity, OkrKREvent, OkrGlobal, OkrInitiative, OkrKeyResult, OkrObjective, OkrProject, OkrSnapshot, OkrTeamScope
