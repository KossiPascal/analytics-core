...
# from backend.src.projects.okr_manager.models import OkrProject
# from backend.src.projects.okr_manager.models import OkrActivity, OkrInitiative, OkrKeyResult, OkrGlobal, OkrObjective, OkrTeamScope, OkrProject
# from backend.src.projects.okr_manager.calculations import calculate_project_progress, calculate_okr_global_progress, calculate_okr_team_progress, calculate_objective_progress, calculate_kr_progress
...
#     okr_globals:List[OkrGlobal] = OkrGlobal.query.all()

#     dashboard_data = {"projects": [], "okr_globals": []}
...
#         global_prog = calculate_okr_global_progress(db.session, okr_global)
#         teams_data = []

#         okr_teams:List[OkrTeamScope] = okr_global.okr_teams
#         for team in okr_teams:
#             team_prog = calculate_okr_team_progress(db.session, team)
#             objectives_data = []
...
#             })
#         dashboard_data["okr_globals"].append({
#             "id": okr_global.id,
#             "title": okr_global.title,
