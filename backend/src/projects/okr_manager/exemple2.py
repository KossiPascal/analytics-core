...
# link_togo = ActivityLinkKR(activity_id=act_togo.id, kr_id=kr_togo.id, impact=0.8)
# link_benin = ActivityLinkKR(activity_id=act_benin.id, kr_id=kr_benin.id, impact=0.7)
...
# # 6️⃣ Événements KR
# # -------------------------------
# evt_togo = KREvent(kr_id=kr_togo.id, value=1200, date=date(2026,3,1), source="activity")
# evt_benin = KREvent(kr_id=kr_benin.id, value=1000, date=date(2026,3,2), source="activity")
