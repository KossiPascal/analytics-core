...
from backend.src.projects.equipment_manager.models.email_config import AlertConfig
from backend.src.projects.equipment_manager.models.locations import District, Region, Site
from backend.src.projects.equipment_manager.models.tickets import Issue, ProblemType, RepairTicket, TicketEvent
...
def seed_categories():
    from backend.src.projects.equipment_manager.models.equipment import EquipmentCategoryGroup, EquipmentCategory
...
def seed_brands():
    from backend.src.projects.equipment_manager.models.equipment import EquipmentBrand
...
def seed_employees():
    from backend.src.app.models.employee import Position, Employee, EmployeeProfile
    from backend.src.app.configs.extensions import db
...
def seed_equipment():
    from backend.src.projects.equipment_manager.models.equipment import Equipment, EquipmentCategory, EquipmentBrand
