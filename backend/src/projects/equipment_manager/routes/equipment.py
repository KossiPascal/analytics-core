...
from backend.src.projects.equipment_manager.models.equipment import (
...
from backend.src.projects.equipment_manager.models.tickets import RepairTicket, TicketEvent
