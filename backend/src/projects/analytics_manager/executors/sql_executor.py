...
from backend.src.app.configs.extensions import isAdmin, isSuperAdmin
from backend.src.app.security.sql_guard import validate_sql, jsonify_value
...
def run_sql(conn,sql_text,user=None,max_rows=None,explain=False):
    ...
    user_id, roles, permissions, is_admin, is_superadmin = extract_user_context(user)
