...
from backend.src.projects.analytics_manager.models.dataset import DatasetQuery
from backend.src.projects.analytics_manager.routes.datasets.query.sql_compiler import FULL_OPERATORS, SQLValueParser
...
class ChartValidator:
    ...
    @staticmethod
    def validate_chart(table_name: str, chart: DatasetChartShema, fieldsMap: dict[int, Any]):
...
class ChartSQLBuilder:
    ...
    @staticmethod
    def build_select(chart: DatasetChartShema, fieldsMap: dict[int, Any]):
...
class ChartExecutor:
    ...
    @staticmethod
    def generate_chart_sql(table_name: str, chart: DatasetChartShema, fieldsMap:dict[int, Any]):
...
class ChartTransformer:
    @staticmethod
    def transform(chart_type: str, rows: List[Dict], chart: DatasetChartShema, fieldsMap:dict[int, Any]):
