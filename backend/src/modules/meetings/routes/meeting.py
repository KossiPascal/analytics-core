...
from backend.src.modules.meetings.models.meeting import Meeting, MeetingSummary
from backend.src.modules.meetings.services.summarization_service import get_summarization_service, SUPPORTED_PROVIDERS
...
def _bg_transcribe(app, meeting_id: int, audio_path: str, audio_filename: str, language: str):
    ...
    with app.app_context():
        ...
        from backend.src.modules.meetings.services.transcription_service import (
