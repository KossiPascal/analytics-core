...
class ProblemType(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
...
class RepairTicket(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    ...
    current_holder_id = db.Column(db.String(11), db.ForeignKey("core.users.id", ondelete="SET NULL"), nullable=True)
...
class Issue(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    __tablename__ = "issues"
    __table_args__ = {"schema": "equip"}

    ticket_id = db.Column(db.String(11), db.ForeignKey("equip.repair_tickets.id", ondelete="CASCADE"), nullable=False)
    problem_type_id = db.Column(db.String(11), db.ForeignKey("equip.problem_types.id", ondelete="RESTRICT"), nullable=False)
...
class TicketEvent(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    ...
    user_id = db.Column(db.String(11), db.ForeignKey("core.users.id", ondelete="SET NULL"), nullable=True)
    recipient_employee_id = db.Column(db.String(11), db.ForeignKey("hrm.employees.id", ondelete="SET NULL"), nullable=True)
...
class TicketComment(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
...
class DelayAlertRecipient(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    __tablename__ = "delay_alert_recipients"
    __table_args__ = {"schema": "equip"}

    user_id = db.Column(db.String(11), db.ForeignKey("core.users.id", ondelete="CASCADE"), unique=True, nullable=False)
...
class DelayAlertLog(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
