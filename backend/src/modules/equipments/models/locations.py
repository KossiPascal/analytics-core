...
# class District(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
...
#     region_id = db.Column(db.String(11), db.ForeignKey("core.regions.id", ondelete="CASCADE"), nullable=False)
...
class Site(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    __tablename__ = "sites"
    __table_args__ = {"schema": "equip"}

    # district_id = db.Column(db.String(11), db.ForeignKey("districts.id", ondelete="CASCADE"), nullable=False)
