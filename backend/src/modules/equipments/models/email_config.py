...
class EmailConfig(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
...
class AlertConfig(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
...
class AlertRecipientConfig(db.Model, BaseModel, TenantMixin, TimestampMixin, SoftDeleteMixin, AuditMixin, StatusMixin):
    """
    ...
    employee_id = db.Column(db.String(11),db.ForeignKey("hrm.employees.id", ondelete="CASCADE"),nullable=True)
    position_id = db.Column(db.String(11),db.ForeignKey("hrm.positions.id", ondelete="CASCADE"),nullable=True)
