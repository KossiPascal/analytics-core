...
from backend.src.modules.equipments.models.email_config import AlertConfig, AlertRecipientConfig
from backend.src.modules.equipments.models.tickets import DelayAlertLog, RepairTicket
from backend.src.modules.equipments.services.email_service import send_delay_alert_v2
...
@celery.task(name="backend.src.equipment.tasks.check_ticket_delays")
