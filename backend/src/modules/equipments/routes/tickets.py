...
from backend.src.modules.equipments.models.email_config import AlertRecipientConfig
...
from backend.src.modules.equipments.models.tickets import DelayAlertRecipient, Issue, ProblemType, RepairTicket, TicketComment, TicketEvent
from backend.src.modules.equipments.services.email_service import send_cc_failure_notification, send_ticket_notification
from backend.src.modules.equipments.services.ticket_workflow import generate_ticket_number, get_next_stages, validate_transition
    ...
    if not is_admin:
        ...
        if caller_position_is_asc and caller_employee_id:
            ...
            if caller_orgunit_ids:
                from backend.src.app.models.b_user import UserOrgunitLink
                user_ids_in_zones = (
...
def create_ticket():
    ...
    if creator_dept_code:
        from backend.src.app.models.f_employee import Department as _Dept
...
def send_ticket(id):
    ...
    try:
        ...
        if failed_cc and user_id:
            from backend.src.app.models.b_user import User as AuthUser
