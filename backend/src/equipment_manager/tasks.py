...
from backend.src.celery_app import celery
...
def check_ticket_delays():
    ...
    from backend.src.equipment_manager.models.tickets import RepairTicket, DelayAlertLog
    from backend.src.equipment_manager.services.email_service import send_delay_alert_v2
