...
import { GET_RECO_CHART_PERFORMANCE_DASHBOARD, GET_RECO_VACCINATION_DASHBOARD, GET_RECO_MEG_STOCK_DASHBOARD, GET_RECO_PERFORMANCE_DASHBOARD } from '../controllers/GET_FROM_DB/dashboars';

const Dashboards = Router();

Dashboards.post('/reco-meg-stock-dashboards', Middelware.authMiddleware, GET_RECO_MEG_STOCK_DASHBOARD);
