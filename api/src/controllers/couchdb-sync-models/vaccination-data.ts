...
export async function SyncVaccinationData(report: any, _repoVaccine: Repository<VaccinationData> | null = null): Promise<boolean> {
    try {
        ...
        _vaccine.no_BCG_reason = dataTransform(fields.no_BCG_reason, 'string');
        _vaccine.no_VPO_0_reason = dataTransform(fields.no_VPO_0_reason, 'string');
        _vaccine.no_PENTA_1_reason = dataTransform(fields.no_PENTA_1_reason, 'string');
        _vaccine.no_VPO_1_reason = dataTransform(fields.no_VPO_1_reason, 'string');
        _vaccine.no_PENTA_2_reason = dataTransform(fields.no_PENTA_2_reason, 'string');
        _vaccine.no_VPO_2_reason = dataTransform(fields.no_VPO_2_reason, 'string');
        _vaccine.no_PENTA_3_reason = dataTransform(fields.no_PENTA_3_reason, 'string');
        _vaccine.no_VPO_3_reason = dataTransform(fields.no_VPO_3_reason, 'string');
        _vaccine.no_VPI_1_reason = dataTransform(fields.no_VPI_1_reason, 'string');
        _vaccine.no_VAR_1_reason = dataTransform(fields.no_VAR_1_reason, 'string');
        _vaccine.no_VAA_reason = dataTransform(fields.no_VAA_reason, 'string');
        _vaccine.no_VPI_2_reason = dataTransform(fields.no_VPI_2_reason, 'string');
        _vaccine.no_MEN_A_reason = dataTransform(fields.no_MEN_A_reason, 'string');
        _vaccine.no_VAR_2_reason = dataTransform(fields.no_VAR_2_reason, 'string');
